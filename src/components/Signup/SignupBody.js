                  ...
                  <div>
                    <form onSubmit={formik.handleSubmit}>
                      ...
                      <div className="mb-4 mt-4">
                        ...
                        <input
                          className="border-emerald-500 border-2 text-gray-100 rounded-2xl h-8 bg-inherit shadow appearance-none  w-full py-2 px-3  leading-tight focus:outline-none focus:shadow-outline"
                      ...
                      <div className="mb-4 mt-4">
                        ...
                        <input
                          className="border-emerald-500 border-2  rounded-2xl h-8 bg-inherit shadow appearance-none  w-full py-2 px-3 text-gray-100 leading-tight focus:outline-none focus:shadow-outline"
                      ...
                      <div className="mb-4 mt-4">
                        ...
                        <select
                          id="countries"
                          class="border-emerald-500 border-2  rounded-2xl  bg-inherit shadow appearance-none  w-full py-2 px-3 text-gray-400 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        >
                          ...
                          <option value="UTC−12:00" className="bg-black">
                            UTC−12:00
                          </option>
                          <option value="UTC−04:00" className="bg-black">
                            UTC−04:00
                          </option>
                          <option value="UTC+03:00	" className="bg-black">
                            UTC+03:00
                          </option>
                          <option value="UTC+05:30" className="bg-black">
                            UTC+05:30
                          </option>
                        </select>
